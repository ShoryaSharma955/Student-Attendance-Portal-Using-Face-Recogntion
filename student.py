...
class student:
    def __init__(self,root):
        ...
        self.var_teacher=StringVar()
         ...
         # first image
        img=Image.open(r"C:\Users\shory\OneDrive\Desktop\face recognition system\images\student.jpg")
        ...
        #second image
        img1=Image.open(r"C:\Users\shory\OneDrive\Desktop\face recognition system\images\student1.jpg")
        ...
        #third img
        img2=Image.open(r"C:\Users\shory\OneDrive\Desktop\face recognition system\images\student2.jpg")
        ...
        img_left=Image.open(r"C:\Users\shory\OneDrive\Desktop\face recognition system\images\leftframe1.jpg")
        ...
        course_combo["values"]=("Select Course","CSE","IT","BCA","BBA","MBA")  
        ...
        take_photo_btn=Button(btn_frame1,width=35,text="Take Photo Sample",command=self.generate_dataset,font=("times new roman",13,"bold"),bg="blue",fg="white")
        ...
        img_right=Image.open(r"C:\Users\shory\OneDrive\Desktop\face recognition system\images\rightframe2.jpg")
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="Shorya@7394",database="my_table")
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                self.reset_data()
                conn.close()      
                # -----load predefines data on face frontal from open cv              
                ...
                if not cap.isOpened():
                    messagebox.showerror("Camera Error", "Unable to open video stream or file.")
                    return
                img_id=0    
                while True:
