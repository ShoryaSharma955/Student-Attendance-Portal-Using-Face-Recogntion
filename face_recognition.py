...
class Face_Recognition:
    def __init__(self,root):
        ...
        #  1st image
        img_top=Image.open(r"images\facedetector1.png")
        ...
        # 2nd image
        img_bottom=Image.open(r"images\facedetector2.png")
        ...
        # ----Button
        b1_1=Button(f_label,text="FACE RECOGNITON",cursor="hand2",command=self.face_recog,font=("times new roman",15,"bold"),bg="red",fg="white")
        b1_1.place(x=330,y=630,height=40,width=300)


    # =======attendance==============================

    def mark_attendance(self,i,r,n,d):
        with open("shorya.csv","r+",newline="\n") as f:
